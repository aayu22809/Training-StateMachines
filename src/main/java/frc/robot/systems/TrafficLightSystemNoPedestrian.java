...
public class TrafficLightSystemNoPedestrian {
	/* ======================== Constants ======================== */
	...
	// How long to keep the red light on before setting to red
	private static final double YELLOW_LIGHT_TIME_SEC = 3.0;
    
    // How long to keep the red light on before setting to green
	 ...
	 */
	public TrafficLightSystemNoPedestrian() {
